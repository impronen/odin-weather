...
const fetchWeather = async location => {
  async function searchWithCity() {
    ...
    try {
      const response = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=13b21cb85833440182c95944230805&q=${location}&days=6`);
